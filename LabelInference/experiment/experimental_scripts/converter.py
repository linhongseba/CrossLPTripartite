...
#================================================================================
sheet = xls.add_sheet('Old_accuracy(0.000001)',cell_overwrite_ok=True)

graph=['graph-30','graph-37','graph_imdb','graph_paper']
algorithm=['MRG','ARG','GRF','MRO','ARO'];
...
for g in graph:
    ...
    for a in algorithm:
        y+=1
        tot=0;
        filename=g+'_05_'+a+'_0_0_0.000001_5.txt';
        sheet.write(x,y,find_xls(filename,1))
#================================================================================#================================================================================
sheet = xls.add_sheet('Old_accuracy(-1)',cell_overwrite_ok=True)
...
#================================================================================
#================================================================================
sheet = xls.add_sheet('running_time(0.000001)',cell_overwrite_ok=True)

graph=['graph-30','graph-37','graph_imdb','graph_paper']
algorithm=['MRG','ARG','GRF','MRO','ARO'];

sheet.write(0,0,'running time (ms)')
for i in range(0,5):
    sheet.write(0,1+i,algorithm[i])
...
#================================================================================#================================================================================
sheet = xls.add_sheet('running_time(-1)',cell_overwrite_ok=True)
