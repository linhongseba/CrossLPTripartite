...
set output 'confidence-time.eps'
plot 'confidence-30.txt' using 1:($6/$2) with lp ls 1 title 'Prop 30', \
'confidence-37.txt' using 1:($6/$2) with lp ls 2 title 'Prop 37', \
'confidence-paper.txt' using 1:($6/$2) with lp ls 3 title 'PubMed', \
'confidence-IMDB.txt' using 1:($6/$2) with lp ls 4 title 'IMDB'
clear
