...
set ylabel 'Time per iteration (s)' offset 2
set output 'time-iter.eps'
plot [0.6:4.5] 'Time-iter.txt' using 2 ti 'MRG' ls 1 fs pattern 3, '' using 3 ti 'ARG' ls 8 fs pattern 3, \
