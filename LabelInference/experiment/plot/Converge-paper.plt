...
set key horizon out
set yrange[19000000:23000000]
set xrang [0:100]
set ytics("1.9" 19000000, "2.0" 20000000, "2.1" 21000000, "2.2" 2200000, "2.3" 23000000)
set label "X 10^7" at 0, 23500000 
...
set output 'Converge-paper.eps'
plot 'converge-paper.txt' using 1:2 with lp ls 1 title 'MRG', \
