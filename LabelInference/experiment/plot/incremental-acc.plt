...
set output 'incremental-acc.eps'
plot 'incremental-30.txt' using 1:($8-$5) with lp ls 1 title 'Prop 30', \
'incremental-37.txt' using 1:($8-$5) with lp ls 2 title 'Prop 37', \
'incremental-paper.txt' using 1:($8-$5) with lp ls 3 title 'PubMed', \
'incremental-IMDB.txt' using 1:($8-$5) with lp ls 4 title 'IMDB'
clear
