...
plot "./convergegraph-37.txt"  using 1:2 w lp lw 1 pt 1 title "MR",\
"./convergegraph-37.txt"  using 1:3 w lp lw 1 pt 1 title "MO",\
"./convergegraph-37.txt"  using 1:4 w lp lw 1 pt 1 title "MG",\
"./convergegraph-37.txt"  using 1:5 w lp lw 1 pt 1 title "AR",\
"./convergegraph-37.txt"  using 1:6 w lp lw 1 pt 1 title "AO",\
"./convergegraph-37.txt"  using 1:7 w lp lw 1 pt 1 title "AG",\
"./convergegraph-37.txt"  using 1:8 w lp lw 1 pt 1 title "LP"
set output
...
plot "./convergegraph_paper.txt"  using 1:2 w lp lw 1 pt 1 title "MR",\
"./convergegraph_paper.txt"  using 1:3 w lp lw 1 pt 1 title "MO",\
"./convergegraph_paper.txt"  using 1:4 w lp lw 1 pt 1 title "MG",\
"./convergegraph_paper.txt"  using 1:5 w lp lw 1 pt 1 title "AR",\
"./convergegraph_paper.txt"  using 1:6 w lp lw 1 pt 1 title "AO",\
"./convergegraph_paper.txt"  using 1:7 w lp lw 1 pt 1 title "AG",\
"./convergegraph_paper.txt"  using 1:8 w lp lw 1 pt 1 title "LP"
set output
